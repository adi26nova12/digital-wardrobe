      ...
      <div className="flex-1 px-6 pt-6 pb-10 space-y-8">
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={title} className="flex items-start gap-4 rounded-lg bg-card p-4">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-full bg-primary py-4 text-sm font-body font-semibold text-primary-foreground transition-transform hover:scale-[1.02] active:scale-[0.98]"
        >
          Open My Wardrobe
